...
class ContactDAOMySQL implements ContactDAO {
  ...
  final uriREST = Uri.parse("http://192.168.1.11:8080/contato");
  ...
  @override
  remove(id) async{
    var uri = Uri.parse("http://192.168.1.11:8080/contato/$id");
  ...
  save(Contact contact) async{
    ...
    if(contact.id == null){
      ...
      // alterar
      var resposta = await http.put(uriREST, headers:, body: contactJson);
      statusCode = resposta.statusCode;
    }
